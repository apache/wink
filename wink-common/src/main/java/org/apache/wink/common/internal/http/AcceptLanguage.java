 ...
 *
 * @see <a href='http://tools.ietf.org/html/rfc2616#section-14.4'>RFC 2616 14.4</a>
 */
public class AcceptLanguage {
    
    private static final HeaderDelegate<AcceptLanguage> delegate = RuntimeDelegate.getInstance().createHeaderDelegate(
    ...
    public AcceptLanguage(String acceptLanguageValue, List<Locale> acceptableLanguages, List<Locale> bannedLanguages, boolean anyLanguageAllowed) {
...
//    /**
//     * Constructor.
//     * @param acceptLanguageValue   value of the header; <code>null</code> is possible
...
//    }   // class QLocale
    ...
    /**
     * Provide a list of languages (locales) which are acceptable for the client.
     * If any language is acceptable with some non-zero priority (see {@link #isAnyLanguageAllowed()}),
     * only languages more preferable than wildcard are listed.
     *
     * @return  unmodifiable list, never <code>null</code>; the list is sorted starting with the most
     *          preferable language
     */
    ...
    /**
     * Is any language acceptable?
     * Note that expresions are listed by {@link #getBannedLanguages()}.
     * This means that the value contains wildcard (with non-zero priority)
     * of the header is not present at all.
     *
    ...
    /**
     * A list of non-acceptable (q-value 0) languages, i.e.
     * exception of {@link #isAnyLanguageAllowed()}.
     *
