...
public class WebDAVTestCollectionResource extends WebDAVResource {
    ...
    static {
        ...
        feed = new SyndFeed(new SyndText(WebDAVTestCollectionResource.TITLE), null);
        feed.setUpdated(new Date(0));
        feed.addLink(new SyndLink(AtomConstants.ATOM_REL_EDIT, null, PATH));
        feed.getEntries().addAll(WebDAVTestDocumentResource.entries.values());
    }
