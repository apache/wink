...
<%@page import="org.apache.wink.example.qadefect.store.DataStore"%>
...
<%@page import="org.apache.wink.example.qadefect.resources.TestsResource"%>
<html>
<head>
<STYLE TYPE="text/css"> 
...
<%
        ...
        Collection<TestBean> testCollection = null;
        String defectId = request.getParameter(TestsResource.DEFECT_HTTP_PARAM);
        
        if (defectId == null) {
            testCollection = store.getTests();
        } else {
            DefectBean bean = store.getDefect(defectId);
            testCollection = bean.getTests();
        }
		String borderSize="0";
%>
