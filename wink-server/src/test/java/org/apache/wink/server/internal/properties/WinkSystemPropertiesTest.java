...
public class WinkSystemPropertiesTest extends MockServletInvocationTest {

    private static final String JVM_PROPERTY_VALUE = "dsfds dfsdfd";
    ...
    /**
     * Tests that the property is NOT set in the custom config file so a JVM
     * property is looked for.
     * 
     * @throws Exception
     */
    public void testPropertiesReadFromJVMNotSpecifiedInConfigFile() throws Exception {
        ...
        assertEquals(JVM_PROPERTY_VALUE, response.getContentAsString());
    }
