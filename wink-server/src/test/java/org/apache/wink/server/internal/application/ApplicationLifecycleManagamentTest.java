...
public class ApplicationLifecycleManagamentTest extends MockServletInvocationTest {
        ...
        ofMockery.checking(new Expectations() {
            {
                ...
                /* this will be called if the servlet is destroyed */
                oneOf(ofMock).releaseAll(null);
