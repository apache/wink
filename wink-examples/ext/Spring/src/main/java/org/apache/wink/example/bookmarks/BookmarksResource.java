...
public class BookmarksResource {
    ...
    @Produces({MediaType.APPLICATION_ATOM_XML, MediaType.APPLICATION_JSON})
    public Response createBookmark(String bookmark, @Context UriInfo uriInfo, @Context LinkBuilders linkProcessor) {
    ...
    @GET
    @Produces({MediaType.APPLICATION_ATOM_XML, MediaType.APPLICATION_JSON})
    public SyndEntry getBookmark(@Context LinkBuilders linkProcessor, @Context UriInfo uriInfo,
    ...
    @Consumes(MediaType.TEXT_PLAIN)
    @Produces({MediaType.APPLICATION_ATOM_XML, MediaType.APPLICATION_JSON})
    public SyndEntry updateBookmark(String bookmark, @Context LinkBuilders linkProcessor, @Context UriInfo uriInfo,
            @PathParam("bookmark") String bookmarkId) {
    ...
    @DELETE
    @Produces({MediaType.APPLICATION_ATOM_XML, MediaType.APPLICATION_JSON})
    public SyndEntry deleteBookmark(@Context LinkBuilders linkProcessor, @Context UriInfo uriInfo,
            @PathParam("bookmark") String bookmarkId) {
    ...
    private SyndEntry createEntry(String bookmarkId, String content, LinkBuilders linkProcessor, UriInfo uriInfo) {
