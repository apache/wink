...
public class JaxRsUriTemplateProcessorTest extends TestCase {
    ...
    private static class TestCompilationHandler implements JaxRsCompilationHandler {
        ...
        public TestCompilationHandler(String template, String[] literals, 
                String[] variables, String[] regexes) {
            super();
    ...
    public void testStaticCompile() {
        ...
        TestCompilationHandler handler = new TestCompilationHandler(template, literals, variables, regexes);
    ...
    public void testGetVariables() {
        JaxRsUriTemplateProcessor processor = new JaxRsUriTemplateProcessor("/path1/{var1}/path2{var2:[ab]*}/{var1}");
        UriTemplateMatcher matcher = processor.matcher();
    ...
    public void testTail() {
        JaxRsUriTemplateProcessor processor = new JaxRsUriTemplateProcessor("/path1/{var1}/path2{var2:[ab]*}/{var3}");
        UriTemplateMatcher matcher = processor.matcher();
        matcher.matches("/path1/value%20a/path2abab/valueB/tail%20part");
    ...
    public void testSameVariableTwice() {
        JaxRsUriTemplateProcessor processor = new JaxRsUriTemplateProcessor("/path1/{var1}/path2{var1:[ab]*}/tail");
        UriTemplateMatcher matcher = processor.matcher();
    ...
    public void testTemplateWithCapturingGroupsInRegex() {
        JaxRsUriTemplateProcessor processor = new JaxRsUriTemplateProcessor("/path1/{var1}/{var2:(a)(b)*}/path2/{var3}/tail");
        UriTemplateMatcher matcher = processor.matcher();
    ...
    public void testNewNormalizedInstance() {
        UriTemplateProcessor processor = JaxRsUriTemplateProcessor.newNormalizedInstance("/path1/path2/./../path3");
