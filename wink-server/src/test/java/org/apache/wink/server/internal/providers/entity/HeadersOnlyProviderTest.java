...
public class HeadersOnlyProviderTest extends MockServletInvocationTest {

    private static final String HEADER_NAME  = "realvalue";
    ...
    protected Object[] getSingletons() {
        return new Object[] {new HeadersOnlyWriter()};
    }
    ...
    @Provider
    public static class HeadersOnlyWriter implements MessageBodyWriter<String> {
        ...
        public void writeTo(String t,
            ...
            httpHeaders.putSingle(HEADER_NAME, PROVIDER_STR);
        }
    }
    ...
    public void testUserProviderOverBuiltIn() throws Exception {
        ...
        assertEquals(PROVIDER_STR, response.getHeader(HEADER_NAME));
    }
}
