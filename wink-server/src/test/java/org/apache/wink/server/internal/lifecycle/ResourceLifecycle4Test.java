...
public class ResourceLifecycle4Test extends ResourceLifecycle {
    ...
    static Resource1 res1 = new Resource1();
    static Resource2 res2 = new Resource2();
    static Resource3 res3 = new Resource3();
        ...
        ofMockery.checking(new Expectations() {
            {
                ...
                oneOf(lifecycleManagerMock).createObjectFactory(res1);
                will(returnValue(res1OfMock));
                oneOf(lifecycleManagerMock).createObjectFactory(res2);
                will(returnValue(res2OfMock));
                oneOf(lifecycleManagerMock).createObjectFactory(res3);
    ...
    protected Object[] getSingletons() {
        return new Object[] {res1, res2, res3};
    }

    /**
     * Tests that the resource ObjectFactory's removeAll call is made when the
     * servlet is destroyed and when the ObjectFactory represents a singleton scoped
     * resource.
     * 
     * @throws Throwable
     */
