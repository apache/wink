...
public class ResourceLifecycle7Test extends ResourceLifecycle {
     ...
     * ExceptionMapper for WebApplicationException throws an exception. Also,
     * the removeInstance call should be made after the response processing is
     * done.
     * 
     * @throws Throwable
     */
