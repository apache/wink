...
//        Marshaller m = AtomJAXBUtils.createMarshaller(ctx, new JAXBNamespacePrefixMapper(RestConstants.NAMESPACE_APP));
...
//        Marshaller m = AtomJAXBUtils.createMarshaller(ctx, new JAXBNamespacePrefixMapper(RestConstants.NAMESPACE_APP));
    ...
    private void assertWorkspaces(List<AppWorkspace> expectedWorkspaces, List<AppWorkspace> workspaces) {
        ...
        for (int i = 0 ; i < expectedWorkspaces.size(); ++i) {
            ...
            assertEquals(expectedWorkspace.getOtherAttributes().get(new QName("anyAttirbCollection")),
                    workspace.getOtherAttributes().get(new QName("anyAttirbCollection")));
    ...
    private void assertCollections(List<AppCollection> expectedcollections, List<AppCollection> collections) {
        ...
        for (int i = 0 ; i < expectedcollections.size(); ++i) {
            ...
            assertEquals(expectedCollection.getOtherAttributes().get(new QName("anyAttirbCollection")),
                    collection.getOtherAttributes().get(new QName("anyAttirbCollection")));
            ...
            assertEquals(expectedCategories.get(0).getCategory().get(0).getScheme(), 
                    categories.get(0).getCategory().get(0).getScheme());
            assertEquals(expectedCategories.get(0).getCategory().get(1).getScheme(), 
                    categories.get(0).getCategory().get(1).getScheme());
