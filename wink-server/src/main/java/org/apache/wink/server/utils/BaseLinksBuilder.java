 ...
 * 
 * @param <T>
 *            the derived type of the links builder
...
public interface BaseLinksBuilder<T> {
    ...
    /**
     * Set the resource class that the generated links should link to. If no resource is set then
     * the active resource is used. Setting the resource clears any sub-resource path previously
     * set.
     * 
     * @param resource
     *            a resource class annotated with the {@link javax.ws.rs.Path} annotation
     * @return this links builder
     */
    public T resource(Class<?> resource);

    /**
     * Set the resource instance that the generated links should link to. If no resource is set then
     * the active resource is used. Setting the resource clears any sub-resource path previously
     * set.
     * 
     * @param resource
    ...
    /**
     * Set the sub-resource path that the generated links should link to, relative to the resource
     * set in the builder.
     * 
     * @param template
    ...
    /**
     * Set the base uri for this builder. If not set, or if set to <code>null</code>, then the base
     * uri as obtained from {@link UriInfo#getBaseUri()} is used.
     * 
     * @param base
    ...
    /**
     * Set the uri that the generated links will be relative to, if the generation mode is relative
     * uri's. The uri being set must be absolute and must be prefixed with the base uri set on this
     * links builder. If not set, or if set to <code>null</code>, then the generated links will be
     * relative to the path obtained from {@link UriInfo#getPath()}.
     * 
     * @param relativeTo
     ...
     * 
     * @param name
     *            the name of the query parameter to add to the generated links
     * @param value
     ...
     * 
     * @param relativize
     *            <code>true</code> to produce relative links, <code>false</code> to produce
     *            absolute links
     * @return this links builder
     */
    ...
    /**
     * Build the link(s) and add them to the provided list. The state of the builder is not affected
     * by this method.
     * 
     * @param out
     *            the output list of links to add the generated link(s) to. If the provided list is
     *            <code>null</code> then a new list is created.
