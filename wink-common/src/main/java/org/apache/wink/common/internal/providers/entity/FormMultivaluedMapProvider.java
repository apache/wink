...
public class FormMultivaluedMapProvider implements MessageBodyWriter<MultivaluedMap<String,? extends Object>>,
        MessageBodyReader<MultivaluedMap<String,String>> {

    public long getSize(MultivaluedMap<String,? extends Object> t, Class<?> type, Type genericType, Annotation[] annotations,
            MediaType mediaType) {
        return -1;
    }
    ...
    public void writeTo(MultivaluedMap<String,? extends Object> t, Class<?> type, Type genericType, Annotation[] annotations,
...
//        }
    ...
    public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        ...
        if (!(type1 instanceof Class) || !((Class<?>)type1).equals(String.class) ||
                !(type2 instanceof Class) || !((Class<?>)type2).equals(String.class)) {
            return false;
        }
        return true;
...
//            String valueDecoded = (value == null ? value : URLDecoder.decode(value, "UTF-8"));
