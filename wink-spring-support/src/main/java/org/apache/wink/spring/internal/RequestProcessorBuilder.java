...
public class RequestProcessorBuilder implements ServletContextAware, InitializingBean {
    ...
    public void setRequestProcessorAttribute(String requestProcessorAttribute) {
        this.requestProcessorAttribute = requestProcessorAttribute;
    }

    public String getRequestProcessorAttribute() {
        return requestProcessorAttribute;
    }
