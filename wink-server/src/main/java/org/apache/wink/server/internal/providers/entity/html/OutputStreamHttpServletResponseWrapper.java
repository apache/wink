...
class OutputStreamHttpServletResponseWrapper extends HttpServletResponseWrapper {
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        ...
        // retrieved.
        if (printWriter != null) {
            throw new IllegalStateException("Cannot get Output Stream since Writer was already requested");
        }
    ...
    public PrintWriter getWriter() throws IOException {
        ...
        // retrieved.
        if (isOutputStream) {
            throw new IllegalStateException("Cannot get Writer since Output Stream was already requested.");
        }
        ...
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(
                servletOutputStreamWrapper, getCharacterEncoding());
